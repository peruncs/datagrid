 ...
 *
 * <p>The class is intentionally small. It does not copy, mirror, or repair
 ...
 * vectors in the Store and rebuilds its transient graph on each node.</p>
 */
public final class ClusterStoreIndexes {
     ...
     *
     * <p>This is useful after Store deserialization, when the index group was
     * created by a persistence handler rather than by application code.</p>
     *

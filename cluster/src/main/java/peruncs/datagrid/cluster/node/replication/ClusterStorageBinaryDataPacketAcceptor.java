...
/// A [StorageBinaryDataPacketAcceptor] that forwards completed messages to
...
/// [#dispose()] on the [ClusterStorageBinaryDataMerger]
public interface ClusterStorageBinaryDataPacketAcceptor extends StorageBinaryDataPacketAcceptor, Disposable {
    ...
    static ClusterStorageBinaryDataPacketAcceptor New(final ClusterStorageBinaryDataMerger merger) {
        ...
        /// Returns a failure reported by the asynchronous merger, or `null`.
    ///
    /// @return merger failure, or `null`
    ...
    ///
    /// The default implementation has no deferred work.
    ...
    /// packet transports continue to use [#accept(List)].
    ///
    ...
    /// Returning `true` transfers release responsibility to the acceptor.
    ///
    /// @param data complete binary

 ...
 * subscriptions created for one node. The neutral cluster API starts and
 * stops the node; this package supplies the transport work between those
 * lifecycle calls. A provider instance belongs to one node and must not be

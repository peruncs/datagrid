...
import peruncs.datagrid.cluster.nodelibrary.aeron.AeronClusterReplicationTransportProvider;
import peruncs.datagrid.cluster.nodelibrary.backup.BackupNodeManager;
import peruncs.datagrid.cluster.nodelibrary.backup.BackupProxyHttpClient;
import peruncs.datagrid.cluster.nodelibrary.backup.BackupTarget;
import peruncs.datagrid.cluster.nodelibrary.backup.FilesystemVolumeBackupBackend;
import peruncs.datagrid.cluster.nodelibrary.backup.NetworkArchiveBackupBackend;
import peruncs.datagrid.cluster.nodelibrary.backup.StorageBackupBackend;
import peruncs.datagrid.cluster.nodelibrary.backup.StorageBackupManager;
...
import peruncs.datagrid.cluster.nodelibrary.replication.AfterDataMessageConsumedListener;
...
import peruncs.datagrid.cluster.nodelibrary.replication.ClusterStorageBinaryDataMerger;
import peruncs.datagrid.cluster.nodelibrary.replication.ClusterStorageBinaryDataPacketAcceptor;
...
import peruncs.datagrid.cluster.nodelibrary.replication.StoredReplicationCursorManager;
import peruncs.datagrid.cluster.nodelibrary.store.ClusterStorageManager;
...
import peruncs.datagrid.cluster.nodelibrary.store.StorageNodeHealthCheck;
	...
	protected ClusterReplicationTransport ensureClusterReplicationTransport()
	{
		...
		protected void startBackupNode() throws NodelibraryException
		{
			...
			if (useLatestCursor)
			{
				...
				catch (final peruncs.datagrid.cluster.nodelibrary.exceptions.ReplicationPositionUnavailableException failure)
				{

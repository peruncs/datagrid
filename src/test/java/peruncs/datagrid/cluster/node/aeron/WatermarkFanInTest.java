...
class WatermarkFanInTest {
    ...
    void interruptedShutdownIsDebug() {
        ...
        assertEquals(System.Logger.Level.DEBUG, WatermarkFanIn.levelFor(closed));
    }
    ...
    void genuineRejectionWarns() {
        ...
        assertEquals(System.Logger.Level.WARNING, WatermarkFanIn.levelFor(rejected));
    }
    ...
    void nestedInterruptIsDebug() {
        ...
        assertEquals(System.Logger.Level.DEBUG, WatermarkFanIn.levelFor(wrapped));
    }
}

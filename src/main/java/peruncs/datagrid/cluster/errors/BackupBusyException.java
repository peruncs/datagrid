...
/// of mapping a busy backup to a server error: [peruncs.datagrid.cluster.api.ClusterNode#createScheduledBackup]
/// and [peruncs.datagrid.cluster.api.ClusterNode#createManualBackup] throw it

...
/// Publishes committed Store transactions to the replication transport.
///
...
public interface ReplicationPublisher extends Disposable {
    ...
    default String consumeTypeDictionary() {
        ...
        /// Creates a publisher that ignores all transport work.
    ///
    /// Each call returns a new instance because the message index and
    /// ignore flag are per-publisher lifecycle state.
    ///
    /// @return neutral publisher
    static ReplicationPublisher noOp() {
        ...
        /// Creates a publisher that keeps dictionary data beside its next binary.
    ///
    /// @param delegate destination publisher
    /// @return caching publisher
    static ReplicationPublisher Caching(final ReplicationPublisher delegate) {
    ...
    final class Caching implements ReplicationPublisher {

        private final ReplicationPublisher delegate;
        ...
        private Caching(final ReplicationPublisher delegate) {

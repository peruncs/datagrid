# DataGrid distributed storage with Aeron replication

`peruncs-storage-distributed` moves Eclipse Store binary data between nodes over Aeron.
...
```text
mvn -pl storage/distributed -am verify
```

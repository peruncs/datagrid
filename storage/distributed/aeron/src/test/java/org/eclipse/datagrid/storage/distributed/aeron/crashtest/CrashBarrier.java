...
public final class CrashBarrier implements AutoCloseable
{
	...
	public void reached(final String name, final long sequence)
	{
		...
		try
		{
			...
			{
				throw new AssertionError("timed out waiting to release " + this.point);
			}
		}
		catch (final InterruptedException interrupted)
		{
			Thread.currentThread().interrupt();
			throw new AssertionError("interrupted at " + this.point, interrupted);
		}
	}

	public void release() { this.release.countDown(); }

	@Override
	public void close() { this.release(); }
	...
	public static final class SimulatedCrash extends RuntimeException
	{
		...
		{
			super("simulated crash at " + point + " sequence=" + sequence);
			this.point = point;
			this.sequence = sequence;
		}

		public CrashPoint point() { return this.point; }

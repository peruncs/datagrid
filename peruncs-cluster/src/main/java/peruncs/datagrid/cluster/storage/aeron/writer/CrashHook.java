...
///
/// Normal writes pay only for a thread-local lookup. A test installs a hook
...
/// they validate; applications must never install a hook in production.
///
...
public final class CrashHook {
    ...
    private CrashHook() {
        ...
        /// Installs a hook for the current thread. Passing `null` removes the
